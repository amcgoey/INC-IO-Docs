 ...
 */
export interface DocumentEvaluationSchemaLike {
  fields?: Array<{ key: string }>;
}

export interface DocumentEvaluationUiSchemaLike {
  layout?: string[];
  fields?: Record<string, { computeValue?: unknown; [key: string]: unknown }>;
  events?: unknown;
  evaluationOrder?: string[];
}

export function computeEvaluationOrder(
  documentSchema?: DocumentEvaluationSchemaLike,
  uiSchema?: DocumentEvaluationUiSchemaLike
): string[] {
